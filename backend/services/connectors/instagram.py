...
class InstagramConnector(BaseConnector):
        ...
        try:
            with yt_dlp.YoutubeDL(ydl_opts) as ydl:
                ...
                return {
                    ...
                    "uploader": info.get("uploader") or info.get("creator") or "Unknown Instagram User",
            ...
            return {
                "url": url,
                "title": "Unresolvable Instagram Post",
                "uploader": "Unknown",
                "upload_date": "N/A",
                "duration": 0.0,
                "thumbnail_url": None,
    ...
    def download_asset(self, url: str, output_dir: str) -> str:
        ...
        try:
            with yt_dlp.YoutubeDL(ydl_opts) as ydl:
                ...
                raise FileNotFoundError("Instagram asset file missing.")
        except Exception as e:
            raise RuntimeError(f"Instagram download failure: {e}")
    ...
    def download_screenshot(self, url: str, output_dir: str, name_prefix: str) -> str:
        ...
        try:
            ...
            print(f"Instagram thumbnail download error: {e}")
            return None
