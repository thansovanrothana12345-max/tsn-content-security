...
class YouTubeConnector(BaseConnector):
    def validate(self, url: str) -> bool:
        ...
        return any(p in domain for p in ["youtube.com", "youtu.be", "youtube-nocookie.com"])
    ...
    def extract_metadata(self, url: str) -> dict:
        ...
        try:
            ...
            return {
                "url": url,
                "title": "Unresolvable YouTube Video",
                "uploader": "Unknown",
                "upload_date": "N/A",
                "duration": 0.0,
                "thumbnail_url": None,
    ...
    def download_asset(self, url: str, output_dir: str) -> str:
        ...
        try:
            with yt_dlp.YoutubeDL(ydl_opts) as ydl:
                ...
                # Check dir if extension changed
                video_id = info.get("id")
                if video_id:
                    for file in os.listdir(output_dir):
                        if file.startswith(video_id):
                            return os.path.abspath(os.path.join(output_dir, file))
                raise FileNotFoundError("YouTube video download file missing.")
        except Exception as e:
            raise RuntimeError(f"YouTube download failure: {e}")
    ...
    def download_screenshot(self, url: str, output_dir: str, name_prefix: str) -> str:
        ...
        try:
            ...
            print(f"YouTube thumbnail download error: {e}")
            return None
